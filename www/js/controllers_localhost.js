...
//  }, false);
    ...
    $scope.showSelectValue = function(mySelect) {
        ...
        $http.get('http://localhost/GoCar1/www/rate.php?picktype=' + picktype + '&pkgtype=' + pkgtype ).
 ...
 //alert(document.getElementById("target").value);
  ...
  $scope.rider.from = '';
    ...
    $scope.myBtn = true;
  $scope.pickNow =function(riderfrom,riderdest,phoneno,name,fare) {
      //alert("picknow");
      ...
      $scope.rider.from = riderfrom;
       $scope.rider.dest = riderdest;
        ...
        for (var i = 0; i < 8; i++)
            ...
            var picktype = document.getElementById("cartype").value;
                 //alert(pack);
            $http.get('http://localhost/GoCar1/www/book.php?id=' + loginInfo.user_id + '&riderfrom=' + riderfrom + '&riderdest=' + riderdest + '&phoneno=' + phoneno + '&picktype=' + picktype + '&name=' + name + '&pack=' + pack + '&fare=' + fare).
            success(function (data) {
                //alert("testbook");
                //$state.go('signin');
                //
...
//    }
    ...
    $scope.pickNow = function(type,email,pwd1,pwd2){
        ...
        if(regex.test($scope.email) && $scope.accType != '' && $scope.pwd != '' && $scope.cpwd != ''){
            ...
            //   template: 'Loading...'
            // });
            $http.get('http://localhost/GoCar1/www/signup.php?id=' + uid + '&email=' + uemail + '&password=' + upass + '&cpassword=' + ucpass + '&type=' + type).
            success(function (data) {
                //
                //$ionicLoading.hide();
                if(type == 'Employer'){
    ...
    $scope.go = function(type,email,pwd1,pwd2){
        ...
        if(regex.test($scope.email) && $scope.accType != '' && $scope.pwd != '' && $scope.cpwd != ''){
            ...
            success(function (data) {
                ...
                //$ionicLoading.hide();
                if(type == 'passenger'){
                    var msg = 'You have successfully signed up as an Passenger. Thank you for uisng GoCar.';
                }else{
                    var msg = 'You have successfully signed up as a Driver. Thank you for using GoCar.';
                }
                if (data.status === "0") {
                    //alert(data.status);
...
start.controller('driversignupCtrl', function ($scope, $http, $state, $ionicPopup, $ionicLoading) {
    ...
    $scope.go = function(type,email,pwd1,pwd2){
        ...
        if(regex.test($scope.email) && $scope.accType != '' && $scope.pwd != '' && $scope.cpwd != ''){
            ...
            //   template: 'Loading...'
            // });
            $http.get('http://localhost/GoCar1/www/driversignup.php?id=' + uid + '&email=' + uemail + '&password=' + upass + '&cpassword=' + ucpass + '&type=' + type).
            success(function (data) {
                ...
                //$ionicLoading.hide();
                if(type == 'driver'){
                    var msg = 'You have successfully signed up as an Driver. Thank you for uisng GoCar.';
                }else{
                    var msg = 'You have successfully signed up as a Passenger. Thank you for using GoCar.';
                }
                if (data.status === "0") {
...
start.controller('bookstatusCtrl', function ($scope, $http, $state, $ionicPopup, $ionicLoading) {
    $scope.showA = true;
      $scope.showB = false;
      $scope.showB = false;
    $scope.getdriver = function(){
        var loginInfo = JSON.parse(localStorage.getItem('logininfo'));
            ...
            url: "http://localhost/GoCar1/www/getdriver.php"
        }).then(function (data) {
            //alert(data);
            //$scope.showA = true;
            if(data == ""){
    ...
    $scope.pay = function(id){
        ...
        var loginInfo = JSON.parse(localStorage.getItem('logininfo'));
            ...
            url: "http://localhost/GoCar1/www/getpaidamount.php"
        }).then(function (data) {
            //alert("data");
            $scope.dbValue1 = data;
    ...
    $scope.card = function(){
$http.get('http://localhost/GoCar1/www/test.php').
            success(function (data) {
alert("data");
            }).
            error(function (data) {
    ...
    $scope.paybycard = function(){
        alert("showc");
            ...
            url: "http://localhost/GoCar1/www/single_transactions.php"
        }).then(function (data) {
            alert("data");
            $state.go('signin');
     ...
     $scope.carnumber = carnumber;
      $scope.mobilenumber = mobilenumber;
        ...
        for (var i = 0; i < 8; i++)
            ...
            // });
            //alert(loginInfo.user_id);
            $http.get('http://localhost/GoCar1/www/drivervehicledetails.php?id=' + loginInfo.id + '&name=' + uname + '&carmodel=' + ucarmodel + '&cartype=' + ucartype + '&carnumber=' + ucarnumber + '&mobilenumber=' + umobilenumber).
            success(function (data) {
...
start.controller('availabletripsCtrl', function ($scope, $http, $state, $ionicPopup, $ionicLoading, $interval,$window) {
...
//};
   ...
   $.ajax({
            ...
            url: "http://localhost/GoCar1/www/availablepasstrip.php"
        }).then(function (data) {
            $scope.dbValue = data;
        ...
        $scope.accept =function(id) {
            ...
            //alert(id);
            //alert(driverid);
$http.get('http://localhost/GoCar1/www/checktrip.php?customerid=' + customerid + '&driverid=' + driverid ).
          success(function (data) {
                //alert(data.bookstatus);                    
                if(data.bookstatus =='new'){
                  $http.get('http://localhost/GoCar1/www/updatetrip.php?customerid=' + customerid + '&driverid=' + driverid ).
          success(function (data) {
                //alert(data.bookstatus);                    
...
//				$scope.tblshow = true;
//				$http.get("http://localhost/GoCar1/www/availablepasstrip.php").success(
//				function(response) {
...
start.controller('travelprogressCtrl', function ($scope, $http, $state, $ionicPopup, $ionicLoading,$filter) {
   ...
   $.ajax({
            ...
            url: "http://localhost/GoCar1/www/travelprogress.php"
        }).then(function (data) {
            //alert("selected");
            $scope.dbValue = data;
            //alert($scope.dbValue);
        ...
        $scope.dropoff =function(id) {
            ...
            $http.get('http://localhost/GoCar1/www/dropoff.php?customerid=' + customerid + '&driverid=' + driverid + '&totalfare=' + totalfare  ).
          success(function (data) {
        ...
        $scope.reject =function(id) {
            ...
            var driverid = user_id
            alert(id);
            $http.get('http://localhost/GoCar1/www/driverreject.php?customerid=' + customerid + '&driverid=' + driverid ).
          success(function (data) {
...
//    $state.go('map');
    $scope.signin = function (x,y) {
		...
		$.ajax({
            ...
            url: "http://localhost/GoCar1/www/signin.php"
        }).then(function (data) {
            localStorage.setItem("logininfo", JSON.stringify(data));
...
start.controller('MapCtrl', function($scope,$state ,$cordovaGeolocation,$ionicLoading,$ionicHistory) {
    //localStorage.clear();
    //$ionicHistory.clearHistory();
    $scope.user = {};
      $ionicLoading.show({
...
alert("helloss"); 
   $state.go("riderdest");
    ...
    //$scope.map1 = new google.maps.Map(document.getElementById("map"), mapOptions);
      $scope.clientSideList = [
    { text: "Yellow Cab", value: "bb" },
    { text: "Four Seater", value: "ng" },
    { text: "Eight seater", value: "em" },
    { text: "Mini Bus", value: "ko" }
  ];
